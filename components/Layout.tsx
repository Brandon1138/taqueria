...
const Layout: React.FC<LayoutProps> = ({ children, fullWidth = false }) => {
	...
	return (
		<div className="min-h-screen flex flex-col bg-neutral-900">
			...
			<div
				className={`fixed top-0 right-0 h-full w-80 md:w-96 bg-neutral-900 bg-opacity-80 backdrop-blur-md shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${
