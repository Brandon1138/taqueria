		...
		<div id="featured" className="py-16">
						...
						<div className="relative flex flex-col h-full z-10">
							...
							<div className="p-6 flex flex-col justify-between flex-grow relative">
								<div>
									...
									<h3
										className={`font-extrabold text-xl text-white uppercase tracking-wide ${
			...
			<div className="text-center mt-10">
				<Link
					...
					focus:ring-2 focus:ring-red-700 focus:outline-none transition-all duration-200
					uppercase tracking-wider shadow-md hover:shadow-lg transform hover:-translate-y-1"
					style={{
						fontFamily: "'Courier New', monospace",
						backgroundImage:
							"url('https://www.transparenttextures.com/patterns/concrete-wall.png')",
